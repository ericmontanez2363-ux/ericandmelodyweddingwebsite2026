...
function getDefaultGuests() {
  return [{ name: "Jocelyn Manalo", table: "VIP 1", companions: ["Jocelyn Manalo", "Maria Bianca Ofelia Tabaquin", "Gay Valerie Valmores", "Paul Erik Manalo", "Marilou Constancia Libres", "Mary Grace Ladia", "Zenaida Del Mundo", "Carlo Villacorta", "Alexander Regala", "Jocelyn Paraiso", "Elizabeth Disono"] },
...
{ name: "Liezl Abad", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Judylyn Alvarez", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Aileen Carriedo", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Jr. Gani, Mario", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Joey Cordova", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Edmund Nietes", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Eugenia Nietes", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Setira Mae Ronquillo", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Emma Campolio", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
{ name: "Mark Gane", table: "Table 1", companions: ["Liezl Abad", "Judylyn Alvarez", "Aileen Carriedo", "Jr. Gani", "Mario", "Joey Cordova", "Edmund Nietes", "Eugenia Nietes", "Setira Mae Ronquillo", "Emma Campolio", "Mark Gane"] },
